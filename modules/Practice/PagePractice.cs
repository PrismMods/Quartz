...
public static class PagePractice {
    public static void Create(RectTransform parent) {
        ...
        var sec = GenerateUI.FlatSection(
            ...
            conf.Enabled,
            "Enable Practice Difficulty", "practice_enable", def.Enabled
        );
    ...
    private static void BuildBindingRows(Transform parent, PracticeSettings conf, int index,
        ...
        captureBtn = GenerateUI.Button(
            ...
            () => {
                if(Quartz.UI.Utility.KeyCaptureService.IsCapturing) {
                    Quartz.UI.Utility.KeyCaptureService.Cancel();
                    return;
                }
                if(captureBtn?.Label != null)
                    captureBtn.Label.text = MainCore.Tr.Get("PRESS_A_KEY", "Press a key...");
                Quartz.UI.Utility.KeyCaptureService.Start(
                    key => {
