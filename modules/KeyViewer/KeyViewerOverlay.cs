...
public static partial class KeyViewerOverlay {
    ...
    public static void EnsureConf() {
        ...
        Quartz.Game.KeyBindSync.Register("keyviewer", new KeyViewerSettings().SyncToKeyLimiter,
            static () => IsSyncingToKeyLimiter, static v => SetSyncToKeyLimiter(v));
    }
