...
public static partial class KeyViewerOverlay {
    ...
    private static void EndDmNoteRain(Box box, float now) {
        ...
        box.LastRain.EndTime = NoteEndTime(box.LastRain.StartTime, now);
        box.LastRain = null;
    }
    internal static float NoteEndTime(float startTime, float releaseTime) =>
        startTime + Mathf.Max(0.001f, releaseTime - startTime);
