...
internal static partial class KvStore {
    ...
    private static readonly string[] TransferableSettings = [
        ...
        nameof(KeyViewerSettings.TabubEnabled),
        nameof(KeyViewerSettings.TabubPercent),
        nameof(KeyViewerSettings.TabubImagePath),
        nameof(KeyViewerSettings.TabubOffsetX),
        nameof(KeyViewerSettings.TabubOffsetY),
        nameof(KeyViewerSettings.TabubScale),
    ...
    internal static List<string> DmNoteGaps() {
        try {
            return KvExportShaping.DetectDmNoteGaps(ExportRoot());
        } catch(Exception e) {
