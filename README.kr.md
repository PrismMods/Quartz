...
[![최신 릴리스](https://img.shields.io/github/v/release/Quaaartz/Quartz?include_prereleases&sort=date&label=release&logo=github)](https://github.com/Quaaartz/Quartz/releases/latest)
[![다운로드](https://img.shields.io/github/downloads/Quaaartz/Quartz/total?logo=github&label=downloads)](https://github.com/Quaaartz/Quartz/releases)
[![스타](https://img.shields.io/github/stars/Quaaartz/Quartz?logo=github)](https://github.com/Quaaartz/Quartz/stargazers)
...
0. [modlist.org app](https://github.com/modlist-org/modlist_org_app/releases/latest)과 [Quartz](https://github.com/Quaaartz/Quartz/releases/latest) 다운로드
...
0. MelonLoader가 설치되어 있는지 확인하세요 (그렇지 않다면: [추천](https://github.com/Quaaartz/Quartz#install--melonloader-recommended))
1. [최신 릴리스](https://github.com/Quaaartz/Quartz/releases/latest)에서 `Quartz.zip`을 다운로드 하세요.
...
1. [최신 릴리스](https://github.com/Quaaartz/Quartz/releases/latest)에서 `QuartzUmm.zip`을 다운로드 하세요.
