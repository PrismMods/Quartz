...
public static partial class KeyViewerOverlay {
    ...
    // RawRain / RainGraphic / RainManager (the rain-drop mesh renderer) now
    // live in RainRenderer.cs — a self-contained subsystem with no dependency
    // on KeyViewerOverlay's own state.
