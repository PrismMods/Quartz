...
public enum UISprite {
    ...
    Triangle128 = 11,
    Power128 = 12,
    MagnifyingGlass128 = 13,
    Gamepad128 = 14,
    Wrench128 = 15,
    AdjustmentsHorizontal128 = 16,
    Users128 = 17,
    ClockRewind128 = 18,
    Trash128 = 19,
    QuantumQ = 20,
    ...
    ChevronDown128 = 37,
    Folder128 = 38,
    QuestionMarkCircle128 = 39,
}
public enum UISliceSprite {
    Circle256P1024 = 0,
    Circle256P2048 = 1,
    CircleHalf256P1024 = 2,
    CircleOutline256P1024 = 3,
    CircleOutline256P2048 = 4,
}
public sealed class SpriteManager(ResourceManager resource) : IDisposable {
    ...
    private readonly Dictionary<UISprite, Asset> spriteMap = new() {
        ...
        [UISprite.Move128] = Asset.Move128,
        [UISprite.Eraser128] = Asset.Eraser128,
        [UISprite.Layer128] = Asset.Layer128,
        [UISprite.Primary128] = Asset.Primary128,
        [UISprite.Broom128] = Asset.Broom128,
        [UISprite.Grid128] = Asset.Grid128,
        [UISprite.Plus128] = Asset.Plus128,
        [UISprite.PlusBold128] = Asset.PlusBold128,
        [UISprite.Minus128] = Asset.Minus128,
        [UISprite.Reset128] = Asset.Reset128,
        [UISprite.TurnArrow128] = Asset.TurnArrow128,
        [UISprite.EyeOpen128] = Asset.EyeOpen128,
        [UISprite.EyeClosed128] = Asset.EyeClosed128,
