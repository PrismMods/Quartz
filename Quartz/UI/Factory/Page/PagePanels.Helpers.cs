...
// Display-name helpers + small UI scaffolding shared by the panel sections:
// anchor dropdown labels, per-stat label lookup, list-container builder, drag
// handle, full-rect helper, text-stat inline editor, panel layer handle
// attachment, layer-order commit, plus the color-body host used by the per-stat
// colour editor.
