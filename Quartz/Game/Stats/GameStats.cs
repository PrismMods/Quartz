...
public static class GameStats {
    ...
    public static int XPerfectMinus => Quartz.Features.Interop.XPerfectBridge.MinusCount();
    ...
    public static int SessionAttempts => Quartz.Features.PlayCount.PlayCount.SessionAttempts;
    public static int TotalAttempts => Quartz.Features.PlayCount.PlayCount.TotalAttemptsForCurrentMap();
    public static float Best => Quartz.Features.PlayCount.PlayCount.BestForCurrentMap();
    public static float BestStart => Quartz.Features.PlayCount.PlayCount.BestStartForCurrentMap();
