...
[![Latest Release](https://img.shields.io/github/v/release/PrismMods/Quartz?include_prereleases&sort=date&label=release&logo=github)](https://github.com/PrismMods/Quartz/releases/latest)
[![Downloads](https://img.shields.io/github/downloads/PrismMods/Quartz/total?logo=github&label=downloads)](https://github.com/PrismMods/Quartz/releases)
[![Stars](https://img.shields.io/github/stars/PrismMods/Quartz?logo=github)](https://github.com/PrismMods/Quartz/stargazers)
...
1. Download [modlist.org app](https://github.com/modlist-org/modlist_org_app/releases/latest) and [Quartz](https://github.com/PrismMods/Quartz/releases/latest)
...
0. First make sure you have MelonLoader, (if not follow [Recommended](https://github.com/PrismMods/Quartz#install--melonloader-recommended))
1. Download `Quartz.zip` from [releases](https://github.com/PrismMods/Quartz/releases/latest).
...
1. Download `QuartzUmm.zip` from [releases](https://github.com/PrismMods/Quartz/releases/latest).
